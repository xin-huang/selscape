...
rule create_examples_high:
    input:
        expand("examples/data/Human/raw/full_chr{i}.vcf.gz", i=example_chrs_high),
        expand(
            "examples/data/Human/ancestral_alleles/homo_sapiens_ancestor_GRCh38/homo_sapiens_ancestor.{i}.bed.gz",
            i=example_chrs_high,
        ),
        expand(
            "examples/data/Human/repeats/hg38.{type}.autosomes.bed",
...
rule download_ensembl_ancestral_alleles:
    ...
    shell:
        ...
        tar -xvzf {output.anc_alleles} -C examples/data/Human/ancestral_alleles
        """
