...
rule infer_1pop_dm_warm_up:
    ...
    params:
        ...
        p0=lambda wc: get_dadi_p0("demog_1d_p0", wc),
        ubounds=lambda wc: get_dadi_bounds("demog_1d_ub", wc),
        lbounds=lambda wc: get_dadi_bounds("demog_1d_lb", wc),
...
rule infer_dfe_warm_up:
    ...
    params:
        ...
        p0=lambda wc: get_dadi_p0("dfe_1d_p0", wc),
        ubounds=lambda wc: get_dadi_bounds("dfe_1d_ub", wc),
        lbounds=lambda wc: get_dadi_bounds("dfe_1d_lb", wc),
