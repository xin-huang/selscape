...
rule delta_tajima_d_outlier_genes_table_html:
    ...
    output:
        html=report(
            ...
            category="Positive Selection",
            subcategory="{method}",
            labels=lambda wildcards: delta_tajima_d_labels(wildcards, type="Gene List"),
        ),
    params:
        title=add_scikit_allel_title,
    log:
...
rule delta_tajima_d_enrichment_results_table_html:
    ...
    output:
        html=report(
            ...
            category="Positive Selection",
            subcategory="{method}",
            labels=lambda wildcards: delta_tajima_d_labels(wildcards, type="Enrichment Table"),
        ),
    params:
        title=add_scikit_allel_title,
    log:
